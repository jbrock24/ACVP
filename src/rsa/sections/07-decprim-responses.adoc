...
| DecryptionPrimitive | SP800-56Br2 |
| JSON Value | Description | JSON type
...
The following is an example of the response for RSA / Decryption Primitive / v1.0 .
...
The following is an example of the response for RSA / Decryption Primitive / 56Br2 .
